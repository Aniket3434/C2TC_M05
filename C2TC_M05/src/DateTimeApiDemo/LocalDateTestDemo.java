...
public class LocalDateTestDemo {

	public static void main(String[] args) {
		//getLocalDateDemo1();
		DayOfWeek dayOfWeek = LocalDate.parse("2022-03-01").getDayOfWeek();
		System.out.println(dayOfWeek);
		int dayOfMonth = LocalDate.parse("2022-03-01").getDayOfMonth();
		...
		boolean before = LocalDate.parse("2022-03-01").isBefore(LocalDate.parse("2022-02-01"));
	...
	private static void getLocalDateDemo1() {
		...
		Clock Clock = java.time.Clock.systemDefaultZone();
		...
		System.out.println("--------------------------------");
		LocalDate localDate4 = LocalDate.of(2022, 03, 02);
		System.out.println(localDate4);
		
		LocalDate localDate5 = LocalDate.parse("2022-03-01");
